 ...
 * 重新Line
 */
public class MyLine extends Line implements Serializable, MyShape {
    ...
    public MyLine(boolean dashLine, double startX, double startY, double endX, double endY,
    ...
    public Shape deepCopy(double x, double y) {
        ...
        MyLine newCircle = new MyLine(dashLine, x, y, this.pos[2] + offsetX, this.pos[3] + offsetY,
    ...
    public Shape reply() {
        ...
        MyLine newShape = new MyLine(dashLine, this.getPosX(), this.getPosY(), this.pos[2], this.pos[3],
